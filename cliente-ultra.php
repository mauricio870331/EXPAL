    ...
    <head>
        ...
        <script>
            ...
            $(document).ready(function () {
                ...
                if (token == 'true') {
                    var l = document.getElementById('bot_acumulakm');
                    l.click();
                }
            });
            ...
            function validarForm() {
                if (document.valid_form.cedula_correo.value.length == 0) {
                    alert("Digite el número de documento");
                    document.valid_form.cedula_correo.focus();
                    return false;
                } else {
                    document.valid_form.action = "Model/envia_clave.php";
    ...
    <body>
        ...
        <div class="slider-wrapper theme-default">
            <div id="slider" class="nivoSlider">
                <img src="imgs/cliente_ultra/Banner-Cliente-Ultra-1.jpg" >
...
-->
               <iframe width="285" height="160" src="https://www.youtube.com/embed/8CGf3lqyH0Y" frameborder="0" allowfullscreen style="margin-bottom: -8px;marging-top:-10px;"></iframe>
                <ul class="botconta"><li><a href="https://www.youtube.com/watch?v=8CGf3lqyH0Y" target="_blank" style="width:250px;margin-top: 18px;" class="botoncu">Se Cliente Ultra en tres pasos..!</a></li></ul>
            </div>
                                ...
                                <form id="formRegistro" name="formRegistro" action="" method="post" class="wpcf7-form"  style="width:100%;" novalidate >
                                    <dl><dt>Nombre</dt>     <dd><input type="text" name="Nombre" value="" size="40" class="f" aria-invalid="false" placeholder="" /></dd>
                                        ...
                                        <dt>Correo Electr&oacute;nico</dt>  <dd>
                                            <input id="correo" type="text" name="Correo_Electronico" value="" size="40" class="f" aria-invalid="false" placeholder="" />
                                        ...
                                        <dd><img style="height:30px !important; float:left;" src="imgs/captcha.png"/> &nbsp; &nbsp; 
                                        ...
                                        <dt style="width:100%;background:#FCE700;clear:both;margin-top:30px;text-align:center;">
                                            &nbsp; <input type="checkbox" name="acepto" id="acepto"  /> <a href="Politica_de_tratamiento_de_Datos.pdf" target="_blank">Acepto (Ver la Pol&iacute;tica de Tratamiento de Datos)</a> &nbsp; &nbsp; 
                        ...
                        <div id="iniciosesionmodal">
                            ...
                            <div class="modal-inism">
                                ...
                                <div id="areasesion2">
                                    ...
                                    <form name="valid_form" id="valid_form" name="modal" method="post">
                                        ...
                                        <input type="button" id="enviar_modal" class="btn btn-success" onclick="validarForm()" value="Enviar" style="background:#005F28; color:#ffffff; padding:4px 16px; margin-top:3px;">
                                    </form>
                                </div>
                            </div>
                        </div>

                        <a href="#iniciosesionmodal" class="botoncu" id="bot_acumulakm2">Ver Premios</a>
                </ul>
            </div>
        </div>
