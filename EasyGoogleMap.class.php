...
class EasyGoogleMap {
	...
	function InitJs() {
		...
		if ($is_error) { 
			...
			$ret .= "	icon.image = 'http://www.expresopalmira.com.co/base/favicon.png'; \n";
			...
			for ($i=$cnt_add-1; $i>=0; $i--) {
				...
				$ret .= "		}\n";
				$ret .= "		else {\n";
				$ret .= "		  map.setCenter(new GLatLng(3.46612,-76.521857), {$this->mMapZoom});\n";
				$ret .= "		}\n";
				$ret .= "	  }\n";
	 ...
	 */
	function GmapsKey() {
		return "<script type=\"text/javascript\" src=\"https://maps.google.com/maps?file=api&v=2&key={$this->mMapKey}\">/*** EasyGoogleMap Class by: Mitchelle Pascual ***/</script>\n";	
	} # end function
