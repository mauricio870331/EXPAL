                                    ...
                                    <div class="x_content">
                                        ...
                                        <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <select  id="link" name="link" style="width: 100%;height: 33px;" onchange="show(this.value)">
                                            ...
                                            <div id="hide" class="form-group" style="display: none;">
                                                ...
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <input type="text" id="url" class="form-control col-md-7 col-xs-12">
                                                </div>
                                            </div> 
        ...
        <script>
                                                        ...
                                                        function addParrafo(opc) {
                                                            ...
                                                            if (link == 'S') {
                                                                url = $("#url").val();
                                                                campos = {"desc": desc,
                                                                    "conv": conv, "cons": i, "opc": opc, "link": link, "url": url};
                                                            } else {
                                                                url = "--";
                                                                campos = {"desc": desc,
                                                                    "conv": conv, "cons": i, "opc": opc, "link": link, "url": url};
                                                        ...
                                                        function saveParrafo() {
                                                            $.ajax({
                                                                ...
                                                                success: function (response) {
                                                                    if (response == 1) {
                                                                        showAlert("green", "Información..!", "Parrafos creados con éxito", "info");
                                                                        setTimeout("redirect()", 2000);
                                                                    } else if (response == 2) {
                                                                        showAlert("red", "Información..!", "No has ingresado parrafos", "info");                                                                        
                                                                    } else {
                                                                        showAlert("red", "Aviso..!", "Ocurrio un error al crear los Parrafos", "info");
...
//showAlert("red", "Aviso..!", "Ocurrio un error al subir la imagen", "info");
                                                        ...
                                                        function redirect() {
                                                            window.location.href = "ListParrafos.php";
                                                        }

                                                        function redirect2() {
                                                            window.location.href = "CrearParrafos.php";
                                                        }
