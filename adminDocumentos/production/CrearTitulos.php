                                                        ...
                                                        function saveParrafo() {
                                                            if ($('#datatable >tbody >tr').length > 0) {
                                                                $.ajax({
                                                                    ...
                                                                    success: function (response) {
                                                                        if (response == 1) {
                                                                            showAlert("green", "Información..!", "Titulos creados con éxito", "info");
                                                                ...
                                                                showAlert("red", "Aviso..!", "No hay datos para guardar", "info");
                                                            }
