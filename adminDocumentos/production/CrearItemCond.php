    ...
    <body class="nav-md">
        ...
        <script>
                                                        ...
                                                        function addParrafo(opc) {
                                                            ...
                                                            var campos = {"desc": desc,
                                                                "conv": conv, "cons": i, "opc": opc};
                                                            var countEmpty = 0;
...
//showAlert("red", "Aviso..!", "Ocurrio un error al subir la imagen", "info");
                                                        ...
                                                        function redirect() {
                                                            window.location.href = "ListItemsCond.php";
                                                        }

                                                        function redirect2() {
                                                            window.location.href = "CrearItemCond.php";
                                                        }
