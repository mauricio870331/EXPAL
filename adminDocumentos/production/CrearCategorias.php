                                        ...
                                        <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <input type="text" id="id" class="form-control col-md-7 col-xs-12">
                                                </div>
                                            </div> 

                                            <div class="form-group">
                                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="cat">
                                                    Nombre Categoria
                                                    <span class="required">*</span>
                                                </label>
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                            ...
                                            <div class="form-group">
                                                <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                                                    ...
                                                    <button type="button" class="btn btn-success" onclick="createCat()">Crear</button>                          
                                                </div>
                                            </div>
                                                        ...
                                                        function createCat() {
                                                            ...
                                                            $.ajax({
                                                                ...
                                                                success: function (response) {
                                                                    if (response == 1) {
                                                                        showAlert("green", "Información..!", "Categoria creado con éxito", "info");
                                                                        setTimeout("redirect()", 2000);
                                                                    } else {
                                                                        showAlert("red", "Aviso..!", "Ocurrio un error al crear la Categoria", "danger");
...
//showAlert("red", "Aviso..!", "Ocurrio un error al subir la imagen", "info");
                                                        ...
                                                        function redirect2() {
                                                            window.location.href = "CrearCategorias.php";
                                                        }
