...
$object = $conexion->findAll("header_detalle_dcto");
                    ...
                    <div class="">
                        <div class="page-title">
                            <div class="title_left">
                                <h4> 
                                    Listado de Titulos del Detalle
                                </h4>
                            </div>
                                                    ...
                                                    foreach ($object as $value) {
                                                        ...
                                                        <tr>                                                             
                                                            ...
                                                            <td style="vertical-align: middle"> 
                                                                <a href="ListSubtitulos.php?id=<?php echo $value->id ?>&titulo=<?php echo $value->descripcion ?>" data-placement="top"  title="Ver Subtitulos" data-toggle="tooltip"><span style="font-size:15px;cursor:pointer;display:inline-block" class="fa fa fa-eye"></span></a> | 
                                                                <a href="CrearSubtitulos.php?id=<?php echo $value->id ?>&titulo=<?php echo $value->descripcion ?>" data-placement="top"  title="Agregar Subtitulos" data-toggle="tooltip"><span style="font-size:15px;cursor:pointer;display:inline-block" class="fa fa fa-plus"></span></a> | 
                                                                <a data-placement="top"  title="Editar"
                                                                   data-toggle="tooltip">
                                                                    <span style="font-size:15px;cursor:pointer;display:inline-block" 
                                                                          data-toggle="modal" data-target="#viewFiles"
                                                                          onclick="viewToUpdate('<?php echo $value->id ?>', '<?php echo $value->numero ?>', '<?php echo $value->descripcion ?>', '<?php echo $value->id_convenio ?>')"  class="fa fa fa-pencil">
                                                                    </span></a> | 
                        ...
                        <div class="modal-dialog modal-sm">
                            <div class="modal-content">
                                ...
                                <div class="modal-header">
                                    ...
                                    <h4 class="modal-title" id="myModalLabel2">Eliminar Titulo</h4>
                                </div>
                                <div class="modal-body">
                                    <h5><b>Esta Seguro de Eliminar el Titulo..?<b></h5>  
                                                <input type="hidden" id="id_delete">                        
                                                </div>
                                                <div class="modal-footer">
                                                    <button type="button" class="btn btn-default" data-dismiss="modal" >Cancelar</button>
                                                    <button type="button" class="btn btn-danger" onclick="updateDeleteTitulo(2)" >Eliminar</button>
                                                </div>
                                                    ...
                                                    <div class="modal-dialog modal-sm" style="width:500px !important;">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-header">
                                                                ...
                                                                <h4 class="modal-title" id="myModalLabel2">Editar Titulo detalle</h4>
                                                            </div>
                                                            ...
                                                            <div class="modal-footer">
                                                                ...
                                                                <button type="button" class="btn btn-success" onclick="updateDeleteTitulo(1)">Guardar</button>
                                                            </div>
                                                ...
                                                <script>
                                                                    ...
                                                                    function viewToUpdate(id, numero, descripcion, id_convenio) {
                                                                    ...
                                                                    function updateDeleteTitulo(opc) {
                                                                        var parametros, msn, msn2;
                                                                        if (opc == 1) {
                                                                            msn = "El titulo se actualizo con exito";
                                                                            msn2 = "Error al actualizar el titulo";
                                                                            parametros = {"id": $('#id_update').val(), "desc": $('#desc').val(), "conv": $('#conv').val(), "orden": $('#orden').val(), "opc": opc};
                                                                        } else {
                                                                            msn = "El titulo se elimino con exito";
                                                                            msn2 = "Error al eliminar el titulo";
                                                                            parametros = {"id": $('#id_delete').val(), "opc": opc};
                                                                        }

                                                                        $.ajax({
                                                                            data: parametros,
                                                                            url: 'Model/updateDeleteTitulo.php',
                                                                            type: 'post',
                                                                            beforeSend: function () {
                                                                                //$("#responseKm").html("...");
                                                                            },
