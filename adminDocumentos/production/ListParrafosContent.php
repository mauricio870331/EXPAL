...
$object = $conexion->findAll("parrafos_conv");
...
<html lang="en">
    ...
    <body class="nav-md">
        <div class="container body">
            <div class="main_container">
                ...
                <div class="right_col" role="main">
                                                    ...
                                                    foreach ($object as $value) {
                                                        ...
                                                        <tr>                                                             
                                                            ...
                                                            <td style="vertical-align: middle"> 
                                                                <a data-placement="top"  title="Ver Contenido" data-toggle="tooltip">
                                                                    <span style="font-size:15px;cursor:pointer;display:inline-block" 
                                                                          data-toggle="modal" data-target="#viewFiles"
                                                                          onclick="viewToUpdate('<?php echo $value->id ?>', '<?php echo $value->descripcion ?>', '<?php echo $value->id_convenio ?>', '<?php echo $value->numero ?>')" class="fa fa fa-pencil">
                                                                    </span>
                                                                </a> 
                                                                |
                                                                <a data-placement="right"  title="Eliminar" data-toggle="tooltip">
                                                                    <span class="fa fa-eraser" style="font-size:15px;cursor:pointer;display:inline-block"
                                                                          data-toggle="modal" data-target="#deleteParrafo"
                                    ...
                                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                ...
                                                <input type="hidden" id="id_parrafo"/>
                                            </div>
                                        </div>                                                                    
                                    </form>      
                                </div>
                    ...
                    <!-- Small modal -->
                    <div class="modal fade bs-example-modal-sm" id="deleteParrafo" tabindex="-1" role="dialog" aria-hidden="true">
                        <div class="modal-dialog modal-sm">
                            <div class="modal-content">
                                ...
                                <div class="modal-header">
                                    ...
                                    <h4 class="modal-title" id="myModalLabel2">Eliminar Parrafo</h4>
                                </div>
                                <div class="modal-body">
                                    <h4 class="modal-title">Estas seguro de eliminar el parrafo ?</h4>
        ...
        <script>
                                        ...
                                        function redirect2() {
                                            window.location.href = "ListParrafosContent.php";
                                        }
                                        ...
                                        function updateDeleteParrafo(opc) {
                                            var orden, desc, conv, id_parrafo, msn, msn2;
                                            var campos;
                                            if (opc == 1) {
                                                orden = $('#orden').val();
                                                desc = $('#desc').val();
                                                conv = $('#conv').val();
                                                id_parrafo = $('#id_parrafo').val();
                                                campos = {"orden": orden, "desc": desc, "id_parrafo": id_parrafo, "conv": conv, "opc": opc};
                                                msn = "El Parrafo fue actualizado con éxito";
                                                msn2 = "Ocurrio un error al actualizar el Parrafo";
                                            } else {
                                                id_parrafo = $('#id_delete2').val();
                                                campos = {"id_parrafo": id_parrafo, "opc": opc};
                                            ...
                                            $.ajax({
                                                data: campos,
                                                url: 'Model/updateDeleteParafos.php',
                                                type: 'post',
                                                beforeSend: function () {
                                                    //$("#responseKm").html("...");
                                                },
