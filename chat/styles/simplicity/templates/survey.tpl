...
<script type="text/javascript" language="javascript" src="${webimroot}/js/${jsver}/myscript.js"></script>
</head>
<body>

<div id="whitebg">
  	<form name="surveyForm" method="post" action="${webimroot}/client.php" onSubmit="return revisar(this)">
			...
			<tr>
				<td>
					<table cellspacing="3" cellpadding="0" border="0">
						<tr>
							<td><a href="javascript:revisar(this);" title="${msg:presurvey.submit}"><img src="${tplroot}/images/buttons/exec.gif" border="0" alt="${msg:presurvey.submit}"/></a></td>
							<td class="button"><a href="javascript:revisar(this);" title="${msg:presurvey.submit}">${msg:presurvey.submit}</a></td>
						</tr>
					</table>
				</td>
				<td align="right">
